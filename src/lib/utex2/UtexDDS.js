...
export class UtexDDS {
  ...
  // if(UTEX==null) UTEX = {};
    ...
    decode(buff)
    {
      ...
      var mgck = utils.readASCII(data, offset, 4);  offset+=4;

      var head, pf, hdr10;

      head = this.readHeader(data, offset);  offset += 124;
      pf = head.pixFormat;
      if( (pf.flags&C.DDPF_FOURCC) && pf.fourCC=="DX10") {  hdr10 = this.readHeader10(data, offset);  offset+=20;  }
      //console.log(head, pf);
    ...
    readHeader(data, offset)
    {
      ...
      var hd = {};
      offset+=4;	// size = 124
      hd.flags    = utils.readUintLE(data, offset);  offset+=4;
      hd.height   = utils.readUintLE(data, offset);  offset+=4;
      hd.width    = utils.readUintLE(data, offset);  offset+=4;
      hd.pitch    = utils.readUintLE(data, offset);  offset+=4;
      hd.depth    = utils.readUintLE(data, offset);  offset+=4;
      hd.mmcount  = utils.readUintLE(data, offset);  offset+=4;
      offset+=11*4;	// reserved, zeros
      hd.pixFormat= this.readPixFormat(data, offset);  offset+=32;
      hd.caps     = utils.readUintLE(data, offset);  offset+=4;
      hd.caps2    = utils.readUintLE(data, offset);  offset+=4;
      hd.caps3    = utils.readUintLE(data, offset);  offset+=4;
      hd.caps4    = utils.readUintLE(data, offset);  offset+=4;
    ...
    writeHeader(data, w,h, gotAlpha, offset)
    {
      ...
      utils.writeUintLE(data, offset,    124);  offset+=4;
      utils.writeUintLE(data, offset,   flgs);  offset+=4;  // flags
      utils.writeUintLE(data, offset,      h);  offset+=4;
      utils.writeUintLE(data, offset,      w);  offset+=4;
      utils.writeUintLE(data, offset,  pitch);  offset+=4;
      utils.writeUintLE(data, offset,  depth);  offset+=4;
      utils.writeUintLE(data, offset,     10);  offset+=4;
      offset+=11*4;
      this.writePixFormat(data, gotAlpha, offset);  offset+=32;
      utils.writeUintLE(data, offset,   caps);  offset+=4;  // caps
      offset += 4*4;
    }
    ...
    readPixFormat(data, offset)
    {
      ...
      var pf = {};
      offset+=4;  // size = 32
      pf.flags    = utils.readUintLE(data, offset);  offset+=4;
      pf.fourCC   = utils.readASCII(data, offset,4);  offset+=4;
      pf.bitCount = utils.readUintLE(data, offset);  offset+=4;
      pf.RMask    = utils.readUintLE(data, offset);  offset+=4;
      pf.GMask    = utils.readUintLE(data, offset);  offset+=4;
      pf.BMask    = utils.readUintLE(data, offset);  offset+=4;
      pf.AMask    = utils.readUintLE(data, offset);  offset+=4;
      return pf;
    }
    ...
    writePixFormat(data, gotAlpha, offset)
    {
      ...
      utils.writeUintLE(data, offset,   32); offset+=4;
      utils.writeUintLE(data, offset, flgs); offset+=4;
      utils.writeASCII(data, offset, gotAlpha?"DXT5":"DXT1");  offset+=4;
      offset+=5*4;
    }
